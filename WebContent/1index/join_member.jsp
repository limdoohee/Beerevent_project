		...
		<div id="main">
			<div id="content">
				<div class="page_location">
					<a href="/">홈</a>
					&gt;
					<strong class="current">일반회원가입</strong>
				</div>
				<div class="layout-page-header">
					<h2>회원가입</h2>
				</div>
				<form method=post action=join_member_process.net name=join_member>
					<div class="joinWrite">
					<table>
						<tr>
							<td class="memberCols1">아이디</td>
							<td class="memberCols2"><input type=text name=mem_id size=15 maxlength=15 required placeholder=예:abc123>
						...
						<tr>
							...
							<td class="memberCols2">
							<input type=text id=name name=mem_name size=7 maxlength=7 required placeholder="이름을 입력해주세요">
							</td>
						</tr>
						<tr>
							<td class="memberCols1">주민번호</td>
							<td class="memberCols2">
							<input type=text id=jumin1 name=mem_jumin1 size=6 maxlength=6 required placeholder="예:801201">
							&ndash;
							<input type=text id=jumin2 name=mem_jumin2 size=1 maxlength=1 required> ××××××
							</td>
						</tr>
						<tr>
							<td class="memberCols1">휴대폰</td>
							<td class="memberCols2">
							<input type=text id=mobile1 name=mem_phone1 size=4 maxlength=3 required placeholder="010">	&ndash;
							<input type=text id=mobile2 name=mem_phone2 size=4 maxlength=4 required>	&ndash;
							<input type=text id=mobile3 name=mem_phone3 size=4 maxlength=4 required>
						...
						<tr>
							...
							<td class="memberCols2">
							<input type=text id=email name=mem_email size= 20 maxlength=20 required>	@
							<input type=text name=mem_domain id=domain size= 20 maxlength=20 required>
